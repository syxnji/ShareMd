  ...
  const messageContent = (notification) => {
    ...
    if (notification.sender_id === userIdInt) {
      ...
      if (notification.type_id === 1) {
        return (
          <>
            <span className={styles.noticeGroupName}>{notification.name}</span>
            への
            <br />
            <span className={styles.noticeGroupName}>参加リクエスト</span>
          </>
        );
      }
      // MARK: 招待
        ...
        return (
          <>
            ...
            への
            <br />
            <span className={styles.noticeGroupName}>招待</span>
          </>
        );
      }
      ...
      if (notification.type_id === 1) {
        return (
          <>
            ...
            への
            <span className={styles.noticeTypeRequest}>参加リクエスト</span>
            があります
          </>
        );
      }
      // MARK: 招待
        ...
        return (
          <>
            ...
            への
            <span className={styles.noticeTypeInvite}>招待</span>
            があります
          </>
        );
      }
